...
const sevenDayQuests = [
  ...
  { title: "命を守る棚をつくる", detail: "ローリングストックBOX、1週間分の飲み水、1週間分のトイレをチェックする。", reward: 70 },
...
const bonusQuests = [
  ...
  { title: "ローリングストックBOXを作る", reward: 40 },
  { title: "1週間分の飲み水を確認", reward: 50 },
  { title: "1週間分のトイレを準備", reward: 50 },
  { title: "思い出BOXを1つ作る", reward: 30 },
];
const quotes = [
  "その服、あなたの未来に必要ですかな？",
  "思い出は心の中に。モノは手放してOKですぞ。",
  "備蓄は不安ではなく、未来の自分への救援物資ですぞ。",
  "水とトイレは、暮らしを守る最強装備です。",
